...
//method for launching browser
	public static WebDriver startBrowser()throws Throwable
	{
		...
		{
			System.setProperty("webdriver.chrome.driver", "E:\\kumarproject\\ERP_Stock\\CommonDriver\\chromedriver.exe");
	...
	public static void waitForElement (WebDriver driver,String locatortype,String locatorvalue,String timewait)throws Throwable
	{
		...
		else if(locatortype.equalsIgnoreCase("xpath"))
		{
			snumber=driver.findElement(By.xpath(locatorvalue)).getAttribute("value");
				...
				FileWriter fw=new FileWriter("E:\\kumarproject\\ERP_Stock\\CaptureData\\supplier.txt");
		...
		{
			FileReader fr=new FileReader("E:\\kumarproject\\ERP_Stock\\CaptureData\\supplier.txt");
