...
{
	FileInputStream fi=new FileInputStream("E:\\kumarproject\\ERP_Stock\\TestInput\\InputSheet.xlsx");
...
//get sheet from wb
	...
	else if(status.equalsIgnoreCase("Not Executed"))
	{
		...
		FileOutputStream fo=new FileOutputStream("E:\\kumarproject\\ERP_Stock\\TestOutput\\hybrid.xlsx");
		wb.write(fo);
		fo.close();
	}
